...
An original, exploratory study assessing the comparative efficacy of commonly used to quantify degreess of district gerrymandering. We will also assess the usefulness of a new gerrymandering metric based on the convex hull of a congressional district and the representativeness inside the convex hull compared to the congressional district itself. 
